...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideFetchStopsAndFaresOfSchedulesUseCase(trainRepository: TrainRepository): FetchStopsAndFaresOfSchedulesUseCase {
        return FetchStopsAndFaresOfSchedulesUseCase(trainRepository)
    }
}