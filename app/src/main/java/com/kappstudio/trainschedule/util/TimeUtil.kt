...
val detailFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm")
...
fun getNowDateTime(): LocalDateTime = LocalDateTime.parse(LocalDateTime.now().format(detailFormatter))